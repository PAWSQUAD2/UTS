                    ...
                    <div class="profile-header-container p-x-5 pad-t-60px">
                        <div class="row pad-b-40px">
                            <div class="col-md-auto photo-profile mb-5" >
                                <img src="<?php echo $user->photoUrl==null?'images/pp.png':$user->photoUrl;?>" alt="pp" id="my-pp">
                            </div>
                            <div class="col profile-data" >
                                ...
                                <div class="row  mar-t-20px">
                                    ...
                                    if($user->token == unserialize($_SESSION['user'])->token){
                                        echo '<input class="fa fa-wrench" type="submit" value="Edit" style="margin-left: 200px" onclick="window.location='."'profile_edit.php'".';">';
                                    }
                                    echo '<br>
                                </div>
                                <div class="row">
                                ...
                                <hr style="height:2px;border:none;background-color:rgb(82, 82, 82);">';
                                    $pp = $user->photoUrl==null?'images/pp.png':$user->photoUrl;
                                    echo '<script>document.getElementById("my-pp").src= "'.$pp.'"</script>';
                                ?>
                            </div>
                        </div>
                    </div>
