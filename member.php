        ...
        <div class="container profile-container mar-t-20px">
            ...
            <div class="row">
                <div class="col-xl-12 no-padding">
                    <div class="profile-header-container p-x-5 pad-t-60px editor-container" style="overflow:auto;">
                        <div class="emblem">
                            ...
                            <?php
                                ...
                                if(false){
                                    ...
                                    while($data = mysqli_fetch_assoc($result)){
                                        echo '
                                            <tr>
                                                <td class="no-border" style="text-align:center;"><img src="'.($data['photoUrl']? $data['photoUrl'] : "images/pp.png").'" alt="pp" class="avatar"></td>
